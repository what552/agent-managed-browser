...
FAIL=0
STEP=0
# Total gates: build(1) + daemon-start(1) + suites(17 = smoke+auth+handoff+cdp+actions-v2+pages-frames+network-cdp+c05-fixes+policy+element-map+r07c02+r07c03+r07c04+r08c01+r08c02+r08c03+r08c04) + daemon-stop(1) = 20
TOTAL=20
